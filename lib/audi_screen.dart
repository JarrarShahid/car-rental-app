...
class AudiScreen extends StatefulWidget {
  const AudiScreen({super.key});

  @override
  State<AudiScreen> createState() => _AudiScreenState();
}
...
class _AudiScreenState extends State<AudiScreen> {
  ...
  List<Car> getAudiCars() {
    Set<Car> audiCars = {
      ...featuredCars.where((car) => car.brand == "Audi"),
      ...allCars.where((car) => car.brand == "Audi"),
    };
    return audiCars.toList();
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        scrollDirection: Axis.horizontal,
                        itemCount: getAudiCars().length,
                        itemBuilder: (context, index) {
                          return _buildCarCard(getAudiCars()[index]);
                        },
                      ),
                    ),
                  ],
